	...
	function TargetEvent()
	{
		...
		if ($this->_fleet['fleet_target_owner'] != $this->_fleet['fleet_owner']) 
		{
			...
			// transport log
				...
				$new['startPalnet'] 		= $this->_fleet['fleet_start_id'];
				$new['startPalnetName']	 	= $startPlanetName;
				...
				$new['targetPalnet'] 		= $this->_fleet['fleet_end_id'];
				$new['targetPalnetName'] 	= $targetPlanetName;
