...
function ShowStatUpdatePage() {
	...
	// Add update date entry to cronlog  - Des
	$GLOBALS['DATABASE']->query('INSERT INTO ' . CRONJOBS_LOG . ' SET `cronjobId` = 10, 	`executionTime` = "' . Database::formatDate(TIMESTAMP) . '", `lockToken` = "manual"');
