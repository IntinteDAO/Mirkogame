...
$LNG['admin_access_1']				    	= 'Tymczasowo masz dostęp do panelu administracyjnego';
$LNG['admin_access_link']				    = 'Deaktywuj go';
$LNG['admin_access_2']				    	= ', jeśli nie korzystasz już z tych funkcji.';
...
$LNG['lm_forums']							= '<font color=cyan><b>Forum</b></font>';
...
$LNG['ov_newname_specialchar']				= 'Nazwa planety może zawierać tylko litery i cyfry. Oraz znaki _, -, .';
$LNG['ov_newname_done']						= 'Nazwa planety zmieniona';
$LNG['ov_planet_abandoned']					= 'Planeta porzucona';
$LNG['ov_principal_planet_cant_abanone']	= 'Nie możesz porzucić planety macierzystej';
...
$LNG['ov_have_new_message']					= '<b><font color="red" size="3">Masz wiadomość </font></b>';
$LNG['ov_have_new_messages']				= '<b><font color="red" size="3">Masz %d nowych wiadomości</font></b>';
$LNG['ov_planetmenu']						= 'Zmień nazwę / Porzuć planetę';
$LNG['ov_free']								= 'Brak aktywności';
$LNG['ov_news']								= 'Informacje';
...
$LNG['ov_security_confirm']					= 'Potwierdź, że chcesz opuścić planetę %s .';
$LNG['ov_password']							= 'Hasło';
$LNG['ov_delete_planet']					= 'Porzuć';
$LNG['ov_planet_rename']					= 'Zmień nazwę';
$LNG['ov_rename_label']						= 'Nazwa planety';
$LNG['ov_fields']							= 'Pola';
...
$LNG['ov_closed']							= 'Gra chwilowo wyłączona!';
...
$LNG['gl_short_friend']						= '';
$LNG['gl_short_member']						= '';
$LNG['gl_populed_planets']					= '%d planet zamieszkanych';
...
$LNG['gl_alliance_web_page']				= 'Strona sojuszu';
...
$LNG['gl_planet_destroyed']					= 'Opuszczona planeta';
...
$LNG['fl_select_all_ships']					= 'Wszystkie okręty';
$LNG['fl_fleets']							= 'Floty';
$LNG['fl_expeditions']						= 'Ekspedycje';
$LNG['fl_number']							= 'ID';
$LNG['fl_mission']							= 'Misja';
$LNG['fl_ammount']							= 'Okręty (łącznie)';
...
$LNG['fl_expedition_alert_message']			= 'Uwaga! Ekspedycje są niebezpieczne! Możesz stracić wysłaną flotę!';
...
$LNG['fl_in_vacation_player']				= 'Gracz w trybie urlopu';

$LNG['fl_multi_alarm']						= 'Multi-Alarm!';
$LNG['fl_no_slots']							= 'Sloty niedostępne!';
$LNG['fl_planet_populed']					= 'Ta planeta jest już zajęta!';
...
$LNG['fl_from']								= 'Od';
$LNG['fl_arrival_time']						= 'Czas dotarcia';
...
$LNG['fl_acs_invitation_message']			= ' zaprasza do udziału w ataku ACS.';
...
$LNG['fl_not_all_ship_avalible']			= 'Nie wszystkie okręty są dostępne.';
...
$LNG['fl_player_is_strong']					= 'Gracz za silny!';
...
$LNG['sys_forward']							= 'Dalej';
$LNG['sys_back']							= 'Wróć';

//----------------------------------------------------------------------------//
//BUILDINGS - RESEARCH - SHIPYARD - DEFENSES
$LNG['bd_dismantle']						= 'Wyburz';
...
$LNG['bd_building_lab']						= 'Laboratorium w trakcie rozbudowy!';
$LNG['bd_max_lvl']							= '(Maks. poziom: %s)';
$LNG['bd_lvl']								= 'Poziom';
$LNG['bd_research']							= 'Badania';
$LNG['bd_shipyard_required']				= 'Musisz najpierw zbudować stocznię!';
$LNG['bd_building_shipyard']				= 'Fabryka nanitów lub stocznia są rozbudowywane!';
$LNG['bd_available']						= 'Dostępne: ';
$LNG['bd_build_ships']						= 'Buduj';
$LNG['bd_protection_shield_only_one']		= 'Możesz mieć tylko jedną na danej planecie!';
...
$LNG['bd_price_for_destroy']				= 'Koszt wyburzenia:';
$LNG['bd_ready']							= 'Gotowe';
$LNG['bd_finished']							= 'Skończone';
$LNG['bd_maxlevel']							= 'Maksymalny poziom';
$LNG['bd_on']								= 'on';
$LNG['bd_max_builds']						= 'Maksymalna kolejka [%d]';
$LNG['bd_next_level']						= 'Następny poziom:';
$LNG['bd_need_engine']						= 'Wymaga dodatkowo <font color="#FF0000">%s</font> %s';
$LNG['bd_more_engine']						= 'Produkuje dodatkowo <font color="#00FF00">%s</font> %s';
$LNG['bd_jump_gate_action']					= 'Skocz do';
$LNG['bd_cancel_warning']					= 'Przerwanie produkcji zwróci Ci 60% kosztów!';
...
$LNG['sys_nomore_level'] 					= 'Próbujesz wyburzyć budynek ( %s ).';
$LNG['sys_buildlist'] 						= 'Lista budowy'; // budów?
...
$LNG['rs_amount']							= 'Ilość';
$LNG['rs_lvl']								= 'poziom';
$LNG['rs_production_on_planet']				= 'Wydobycie na planecie "%s"';
$LNG['rs_basic_income']						= 'Podstawowe wydobycie';
$LNG['rs_storage_capacity']					= 'Pojemność magazynów';
$LNG['rs_calculate']						= 'Przelicz';
$LNG['rs_sum']								= 'Łącznie:';
$LNG['rs_daily']							= 'Zasobów na dzień:';
$LNG['rs_weekly']							= 'Zasobów na tydzień:';
$LNG['rs_ress_bonus']						= 'Bonus technologiczny:';
...
$LNG['in_jump_gate_error_data']				= 'Błąd, współrzędne do skoku nieprawidłowe!';
...
$LNG['in_base_speed'] 						= 'Prędkość podstawowa';
$LNG['in_consumption'] 						= 'Zużycie paliwa (deuteru)';
...
$LNG['mg_no_text']							= 'Brak treści';
$LNG['mg_msg_sended']						= 'Wiadomość wysłano!';
$LNG['mg_read_marked']						= 'Oznacz jako przeczytaną';
...
$LNG['al_make_ally_insufficient_points']	= 'Nie masz wystarczająco dużo punktów, by stworzyć Sojusz. <br>Wymagana liczba punktów to %s, musisz zdobyć jeszcze %s punktów.';
...
$LNG['bu_new_request_body']					= 'Witaj %s,<br>%s chce zostać twoim znajomym! Wejdź w listę znajomych, by potwierdzić zaproszenie. <a href="https://mirkogame.pl/game.php?page=buddyList&menu=3"><font color=lime>><b>TUTAJ</b><</font></a>';
$LNG['bu_accepted_request_title']			= 'Zaakceptuj zaproszenie!';
...
$LNG['op_activate_vacation_mode']			= 'Aktywuj tryb urlop <font color=red>UWAGA Urlop trwa minimum 3 dni!!</font>';
$LNG['op_dlte_account']						= 'Usuń konto <font color=red>Jeśli zaznaczysz tę opcję, Twoje konto zostanie skasowane po 14dniach</font>';
...
$LNG['op_block_pm']							= 'Zablokuj prywatne wiadomości od graczy';
...
$LNG['css_account_banned_message']			= 'Twoje konto zostało zablokowane! ';
$LNG['css_account_banned_expire']			= 'Jesteś zbanowany do %s <br><a href="./index.php?page=banList">Banlist</a>';
...
$LNG['cff_no_fleet_data']					= 'Brak informacji o okrętach';
$LNG['cff_acs_fleet']						= 'Flota ACS';
...
$LNG['cff_mission_own_mip']					= 'Atak rakietowy (%d) z %s %s %s na %s %s %s.';
...
$LNG['cff_mission_target_mip']				= 'Atak rakietowy (%d) od gracza %s z %s %s %s na %s %s %s.';
//----------------------------------------------------------------------------//
// EXTRA LANGUAGE FUNCTIONS
$LNG['fcm_universe']						= 'Universum';
$LNG['fcm_mainplanet']						= 'Planeta macierzysta';
...
//----------------------------------------------------------------------------//
// MissilesAjax.php
$LNG['ma_silo_level']						= 'Wymagana wyrzutnia na poziomie 4! ';
...
$LNG['ma_no_missiles']						= 'Brak rakiet';
...
$LNG['ma_gauss_canyon']						= 'Działo Gaussa';
$LNG['ma_ionic_canyon']						= 'Działo jonowe';
$LNG['ma_buster_canyon']					= 'Działo plazmowe';
...
$LNG['bs_add_acs_slot']						= 'Dodaj slot ACS';
$LNG['bs_reset']							= 'Reset';
//----------------------------------------------------------------------------//
// Fleettrader

$LNG['ft_head']								= 'Złomowanie floty';
$LNG['ft_count']							= 'Ilość';
$LNG['ft_max']								= 'Maksymalnie';
