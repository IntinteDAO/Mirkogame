<?php
  ...
  402 => 'L. Działo Laserowe',
  403 => 'C. Działo Laserowe',
  404 => 'Działo Gaussa',
  405 => 'Działo Jonowe',
  406 => 'Działo Plazmowe',
  407 => 'M. Powłoka Ochronna',
  408 => 'D. Powłoka Ochronna',
  409 => 'Giga Osłona',
  ...
  3 => 'Deuter jest wydobywany przez ekstraktor, służy jako paliwo oraz materiał budowlany.',
  ...
  24 => 'Zwiększa ilość przechowywanego deuteru',
  31 => 'Konieczne do tego, by móc odkrywać nowe technologie.',
  33 => 'Terraformer przez terraformowanie zwiększa ilość dostępnych pól do zabudowy na planecie.',
  ...
  44 => 'Używane do przechowywania rakiet i przeciwrakiet.',
  106 => 'Dzięki tej technologi mogą być zbierane informacje o innych planetach i księżycach.',
  108 => 'Dzięki rozwojowi technologi komputerowej możesz zarządzać większą ilością flot. Każdy poziom zwiększa ilość flot, którymi możesz zarządzać o 1 slot.',
  109 => 'Technologia Bojowa podnosi efektywność używania broni. Każdy poziom zwiększa obrażenia o 10% wartości bazowej.',
  110 => 'Technologia Ochronna podnosi efektywność wykorzystania osłon statków, jak również ich struktur obronnych. Każdy poziom zwiększa siłę osłony o 10% wartości bazowej!.',
  111 => 'Specjalne stopy metalu zwiększają wytrzymałość opancerzenia. Każdy poziom zwiększa wytrzymałość opancerzenia o 10% wartości bazowej.',
  ...
  124 => 'Moduł astrofizyczny pozwala zbierać dane podczas lotu floty. Zwiększając poziom zyskujesz możliwość kolonizacji wiekszej ilości planet.',
  ...
  403 => 'Ciężkie Działo laserowe to ulepszona wersja lekkiego.',
  ...
  407 => 'Mała Powłoka Ochronna roztacza nad planetą zabezpieczenie, które pochłania część obrażeń.',
  408 => 'Jest to silniejsza wersja małej Powłoki, niestety wymaga również więcej zasobów energii.',
  ...
  502 => 'Przeciwrakiety przechwytują rakiety międzyplanetarne przeciwnika.',
  ...
  3 => 'Deuter jest zwane również ciężką wodą. Służy jako paliwo, jest również potrzebny do niektórych badań. Poza tym potrzebujesz dużych jego ilości, by móc używać Falangi.',
  ...
  6 => 'Z każdym poziomem skraca czas badań o 8%.',
  12 => 'W elektrowniach fuzyjnych jądra ciężkiego wodoru łączą się tworząc jądra helu. Podczas tego procesu wydzielają się niesamowite ilości ciepła i energii. Z jednego grama Deuteru produkujesz 41,32*10^-13 J energii. Im wiekszy poziom rozbudowy reaktora, tym więcej energi produkuje na godzinę.',
  ...
  24 => 'Służy do przechowywania deuteru. Jeśli jest pełny, produkcja na planecie zostaje wstrzymana, a więc warto pilnować, by był odpowiednio rozbudowany.',
  ...
  34 => 'Depozyt pozwala zaopatrywać sojuszniczą flotę stojącą na orbicie w paliwo. Każdy poziom zwiększa ilość dostarczanego paliwa o 10 000 deuteru.',
  ...
  42 => 'Falanga czujników analizuje spektrum światła i gazów w swoim zasięgu, a potem superkomputer dostarcza danych na temat aktywnie przemieszczających się flot. Jednorazowe skanowanie przestrzeni w zasięgu falangi kosztuje 5k Deuteru. Zasięg falangi liczymy tym wzorem =(poziom falangi) ^ 2 - 1.',
  43 => 'Olbrzymie wrota zwane teleporterem pozwalają na transport ogromych flot natychmiast i to nie tracąc deuteru. Po każdym użyciu teleporter musi się zregenerować, by można go było użyć ponownie. Niestety nie da się tą drogą przesyłać surowców.',
  44 => 'Służy do budowy rakiet i przeciwrakiet. Każdy poziom to 10 slotów. Rakieta zajmuje 2 sloty a przeciwrakieta jeden. Np. na poziomie 10 możesz mieć maksymalnie 100 przeciwrakiet lub 50 rakiet lub dowolną kombinację zajmującą 100 slotów.',
  106 => 'Od poziomu tej technologii zależy, jakie dane uda Ci się zebrać o twoim celu. Jeśli przeciwnik ma większy poziom technologii szpiegowskiej, wtedy musisz wysłać więcej sond, by uzyskać maksymalną ilość danych na temat twojego przeciwnika. Większa ilość sond zwiększa szansę ich wykrycia i zniszczenia. Od poziomu 2 dostaniesz informacje ile jednostek cię atakuje, od levelu 4 dowiesz się również jakie typy statków, a od levelu 8 informacje będą pełne, czyli ile i jakie typy statków są agresorami.',
  ...
  117 => 'Napęd ten zazwyczaj składa się z rekatora, zespołu przetworników i dyszy napędowej. Dzieki zmieniszeniu strat między reaktorem a dyszami i usprawnieniu pracy przetworników, statki korzystające z tego typu napędu mogą poruszać się 20% szybciej predkości bazowej. Jako, iż ten napęd jest również używany do napędzania rakiet międzyplanetarnych, każdy poziom zwiększa ich zasięg. Bombowiec, krążownik, ciężki myśliwiec i kolonizator korzystają z tego napędu.',
  118 => 'Wraz z rowojem technologi nadprzestrzennej powstał właśnie taki oto napęd, który zakrzywia czasoprzestrzeń wokół jednostki. Dzieki wypaczeniu czasoprzestrzeni podróż na odległość 1000 lat świetlych została skrócona zaledwie do godziny. Każdy poziom zwiększa predkość statków korzystających z tego napędu o 30% wartości bazowej.',
  ...
  123 => 'Naukowcy z różnych planet komunikują się ze sobą przez tę sieć. Wraz z rozbudową na kolejny poziom, do sieci zostanie przyłączone dodatkowe laboratorium, przy czym przyłączane będą zawsze laboratoria o najwyższym poziomie.',
  124 => 'Moduł astrofizyczny pozwala zbierać dane podczas lotu floty. Zwiększając poziom, zyskujesz możliwość kolonizacji wiekszej ilości planet. Na pierwszym poziomie astrofizyki można kolonizować do 9 planet w układzie o numerach 4-12. Planety o numerach 1-3 i 13-15 mogą być skolonizowane po odkryciu astrofizyki na poziom 4. Poza tym astrofizyka zwiększa również ilość ekspedycji (30 poziom to 5 ekspedycji!).',
  131 => 'Zwiększa produkcję metalu o 2%.',
  132 => 'Zwiększa produkcję kryształu o 2%.',
  133 => 'Zwiększa produkcję deuterium o 2%.',
  ...
  209 => 'Okręt wyspecjalizowany w zbieraniu tego, co zostaje po kosmicznych bitwach, czyli metalu i krzystału z pól zniszczeń. Rozwój oficera ładowności okrętów zwiększa ich maksymalną ładowność do 2 Mln. Po zbadaniu napędu impulsowego do 17 poziomu, recykler zmienia napęd na impulsowy.',
  ...
  503 => 'Służy do niszczenia obrony na planecie. Ma wroga w postaci przeciwrakiet.',
  601 => 'Geolog to specjalista od astro-minerologii i krystalologii. Jego działania odczuwa się w całym imperium.',
  602 => 'Admirał to stary i doświadczony weteran. Mądry imperator mógł liczyć na jego pomoc w walce.',
  603 => 'Inżynier to specjalista w zarządzaniu energią. W czasie pokoju i wojny zwiększa jej produkcję w całym imperium.',
  604 => 'Cech technokratów to naukowcy-geniusze. Swoją obecnością wpływają na innych naukowców, poprawiając sprawność ich pracy.',
