...
{block name="content"}
	...
	<tr>
		...
		<td colspan="2">
			<span id="elementID219"></span> {$LNG.gl_avaible_grecyclers}
		</td>
	</tr>
...
if(event.which == 37){ galaxy_submit('systemLeft');}
if(event.which == 39){ galaxy_submit('systemRight');}   });   
});
