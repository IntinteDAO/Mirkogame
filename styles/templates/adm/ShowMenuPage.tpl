...
<div id="leftmenu">
	<ul id="menu">
		...
		{if allowedTo('ShoweditlangPage')}<li><a href="?page=editlang" target="Hauptframe">Edycja jezyka</a></li>{/if}
		...
		{if allowedTo('ShowFlyingFleetPage2')}<li><a href="?page=fleets2" target="Hauptframe">Te zjebane floty</a></li>{/if}
		<li><a href="?page=fleetslog" target="Hauptframe">{$LNG.fleetslog}</a></li>
		...
		{if allowedTo('ShowErrorlogsPage')}<li class="tools"><a href="?page=Errorlogs" target="Hauptframe"><font color=red>errorLOGS</font></a></li>{/if}
